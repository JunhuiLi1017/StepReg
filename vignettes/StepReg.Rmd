...
Alternatively, you can also access the Shiny app directly with the following code:
...
![](src/StepReg_shiny_UI_description_raw_1.png)

![](src/StepReg_shiny_UI_description_raw_2.png)
