...
Formula_in_Logit_Cox_Poisson_Gamma <- c("logit|cox|poisson|gamma",
                                        ...
                                        "Cox: LRT for forward, and Wald test for backward;<br> Others: LRT/Chao Chi-squre test for forward, and Wald test for backward",
...
colnames(df) <- c("Abb.","Definition","Formula","")
